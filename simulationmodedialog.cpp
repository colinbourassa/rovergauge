...
void SimulationModeDialog::setupWidgets()
{
    ...
    enableSimModeButton = new QPushButton("Enable Sim Mode", this);
    connect(enableSimModeButton, SIGNAL(clicked()), this, SLOT(onEnabledSimModeClicked()));
    ...
    grid->addLayout(buttonLayout, row, 0, 1, 4);
    buttonLayout->addWidget(enableSimModeButton);
